 ...
 * [MerchantDetailsFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [MerchantDetailsFragment.newInstance] factory method to
...
class MerchantDetailsFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): MerchantDetailsFragment {
