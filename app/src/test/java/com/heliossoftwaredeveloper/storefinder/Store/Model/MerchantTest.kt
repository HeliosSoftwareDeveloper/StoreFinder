...
class MerchantTest : BaseMerchantTest(){
    ...
    fun testValidGetMerchantList() {
        ...
        val firstMerchantOnList : Merchant = mockedMerchantListItems[1].merchant!!
        val firstMerchantBranches : List<Merchant.Branches> = mockedMerchantListItems[1].merchant!!.merchantBranches
